        ...
        <div className="preiseContainer" id="PreiseSection">
            ...
            <div className="preisUebersicht">
                <div className="flexContainer">
                    <EinPreis headline="OnePager" preis="mind. 50" blur={false} desc="OnePager sind Webseiten, wie diese. Sie sind simpel angeordnet & der ganze Content ist auf einer übersichtlichen Seite aufgebaut. Solche sind ideal für User, die nicht vom Thema abschweifen sollen, in Unterseiten nicht verlaufen sollen & den Lesefluss nicht stören sollen."/>
                    <EinPreis headline="Homepage" preis="mind. 75" blur={false} desc="Homepages mit Unterseiten sind gut geeignet für ausführlichen Inhalten, die ein Thema tiefer durchdringen. Außerdem schließt diese Art die Zielgruppe ältere Menschen ein. Diese sind oft mit Menüs groß geworden. Sie erwarten “unten auf einer Seite” keine anderen Themen als oben."/>
                    <EinPreis headline="Online Shop" preis="mind. 100" blur={true} desc="Bald verfügbar."/>
                </div>
                <br />
