        ...
        <div className="projectsContainer" id="ProjectsSection">
            ...
            <p className="aboutTextProjects">Hier sind meine Projekte aufgelistet. Die Projekte sind nach der Reihenfolge, die ich diese umgesetzt habe, auch mit einer Nummer gekennzeichnet. Hinzu kommt noch das Jahr, wo es entstand und eine kleine Beschreibung. Zum Abschluss natürlich der Link zur jeweiligen Website &amp; zum Code behind auf Github.
                ...
                <div className="projectsSlider">
                    ...
                    <EinProject disabled={false} number="7" year="2022" title="XIAØHU" text="Diese Seite ist diese, die du dir gerade hier anschaust. Es ist eine Version 2.0 von meiner alten eigenen Webiste 'Hulong Official'." websiteLink="https://xiaohu.de/" githubLink="https://github.com/AndyHu8/hulong-rr"/>
                    <EinProject disabled={false} number="8" year="2023" title="XIAØBOX" text="Die erste Dummy Seite, wo ein E-Commerce Shop entahlten ist. Dadurch habe ich wieder viele neue Erfahrungen gesammelt" websiteLink="https://xiaobox-sanity-stripe.vercel.app/" githubLink="https://github.com/AndyHu8/xiaobox_sanity_stripe"/>
                    <EinProject disabled={false} number="9" year="2023" title="Vorurteile Games" text="Diese repräsentiert Spiele, besonders physische Brettspiele eines guten Freundes. Er hat damit gestartet eigene Brettspiele zu entwerfen & auf dem Markt zu bringen. Also schaut gerne vorbei!" websiteLink="https://vorurteile.games/" githubLink="https://github.com/AndyHu8/brokolee-games-vorurteile"/>
                    <EinProject disabled={false} number="10" year="2023" title="Palmen aus Pappe" text="Eine Seite, um sich stetig die eigenen Skills zu verbessern. Hier habe ich neue Dinge angewendet &amp; ausprobiert." websiteLink="https://palmen-aus-pappe-3.netlify.app/" githubLink="https://github.com/AndyHu8/formular-example"/>
                </div>
            </div>
        </div>
    )
